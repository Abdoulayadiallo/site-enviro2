...
function eco_nature_elementor_activation_notice() {
	...
	echo '<p><a href="'. esc_url( admin_url( 'themes.php?page=eco-nature-elementor-about' ) ) .'" class="button button-primary">'. esc_html__( 'Documentation', 'eco-nature-elementor' ) .'</a></p>';
	echo '</div>';
}
...
add_action( 'wp_enqueue_scripts', 'eco_nature_elementor_load_dashicons_front_end' );
function eco_nature_elementor_load_dashicons_front_end() {
